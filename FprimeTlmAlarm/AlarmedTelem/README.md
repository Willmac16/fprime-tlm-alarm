# AlarmedTelem Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the AlarmedTelem Application

In order to build the AlarmedTelem application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:
...
The next step is to build the AlarmedTelem application's code.
```
fprime-util build
```
...
To run the ground system without starting the AlarmedTelem app:
```
...
```
cd AlarmedTelem/build-artifacts/<platform>/bin/
./AlarmedTelem -a 127.0.0.1 -p 50000
```
