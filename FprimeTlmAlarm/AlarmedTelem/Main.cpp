...
int main(int argc, char* argv[]) {
    ...
    FprimeTlmAlarm::TopologyState inputs;
    ...
    FprimeTlmAlarm::setupTopology(inputs);
    FprimeTlmAlarm::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    FprimeTlmAlarm::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
