// ======================================================================
// \title  AlarmedTelemTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef ALARMEDTELEM_ALARMEDTELEMTOPOLOGYDEFS_HPP
#define ALARMEDTELEM_ALARMEDTELEMTOPOLOGYDEFS_HPP
...
#include "FprimeTlmAlarm/AlarmedTelem/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
    namespace FprimeTlmAlarm_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
 ...
 *
 * The topology autocoder requires an object that carries state with the name `FprimeTlmAlarm::TopologyState`. Only the type
