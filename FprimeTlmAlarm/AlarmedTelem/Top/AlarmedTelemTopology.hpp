// ======================================================================
// \title  AlarmedTelemTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ALARMEDTELEM_ALARMEDTELEMTOPOLOGY_HPP
#define ALARMEDTELEM_ALARMEDTELEMTOPOLOGY_HPP
// Included for access to AlarmedTelem::TopologyState and AlarmedTelem::ConfigObjects::pingEntries. These definitions are required by the
 ...
 * AlarmedTelem::TopologyState see: AlarmedTelemTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FprimeTlmAlarm::TopologyState see: FprimeTlmAlarmTopologyDefs.hpp.
 *
